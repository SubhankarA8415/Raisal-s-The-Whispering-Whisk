...
export function createBakeryReviewEmail({ customerName, rating, reviewText }) {
  ...
  const subject = positive
    ...
    : "We'd love to make your Raisal's Bakery experience better"
  ...
  const intro = positive
    ? "We're genuinely delighted that your experience with the Raisal's Bakery team left you happy. Your kind rating means a lot to everyone behind the counter and in the kitchen."
    : "Thank you for taking the time to share your experience with the Raisal's Bakery team. We're sorry we didn't give you the experience you were hoping for."

  const body = positive
    ? 'Your feedback gives our whole team a little extra joy behind the scenes. We hope to welcome you again and make something special for you soon.'
    : 'If you have a moment, we would genuinely appreciate knowing what we could improve — our service, communication, freshness, presentation, or anything else that mattered to you. Honest feedback helps our whole team become better.'
  ...
  <div style="max-width:620px;margin:0 auto;padding:36px 16px;">
    <div style="overflow:hidden;background:#fff;border:1px solid #e4dbd5;border-radius:18px;box-shadow:0 12px 35px rgba(61,41,35,.07);">
      ...
      <div style="padding:38px;">
        ...
        <div style="margin-top:34px;font-size:12px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#a16b5a;">A little note from our whole team</div>
        ...
        <div style="margin:24px 0;padding:18px;border:1px solid #eadfd9;border-radius:14px;background:#faf8f6;">
          <div style="font-size:12px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:#8b756b;">Your review of our team</div>
        ...
        <p style="margin:4px 0 0;font-size:11px;color:#9a8981;">Thank you for helping our whole team grow.</p>
      </div>
    </div>
